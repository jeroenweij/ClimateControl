...
#define CC_NINA_SCENARIOS(Harness)                                                                                                                                                                                         \
    ...
    {                                                                                                                                                                                                                      \
        ...
        CC_CHECK_EQ(scenario::FailureResets(h), 1);                                                                                                                                                                        \
                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                           \
    CC_TEST(NinaBringUp, BluetoothLeftOnInTheStoredSettingsIsTurnedOffOnce)                                                                                                                                                \
    {                                                                                                                                                                                                                      \
        Harness h;                                                                                                                                                                                                         \
        h.Start();                                                                                                                                                                                                         \
        h.nina.btMode       = 3; /* Classic + LE, as old firmware stored it */                                                                                                                                             \
        h.nina.storedBtMode = 3;                                                                                                                                                                                           \
        CC_CHECK(scenario::RunUntilDataMode(h, 30000));                                                                                                                                                                    \
        CC_CHECK_EQ(h.nina.btMode, 0);                                                                                                                                                                                     \
        CC_CHECK_EQ(h.nina.storedBtMode, 0);                                                                                                                                                                               \
        CC_CHECK_EQ(h.nina.SoftRestarts(), 1);                                                                                                                                                                             \
        CC_CHECK_EQ(scenario::FailureResets(h), 0); /* not a failure */                                                                                                                                                    \
    }                                                                                                                                                                                                                      \
                                                                                                                                                                                                                           \
    CC_TEST(NinaBringUp, BluetoothAlreadyOffCostsNoRestart)                                                                                                                                                                \
    {                                                                                                                                                                                                                      \
        Harness h;                                                                                                                                                                                                         \
        h.Start();                                                                                                                                                                                                         \
        CC_CHECK(scenario::RunUntilDataMode(h, 15000));                                                                                                                                                                    \
        CC_CHECK_EQ(h.nina.SoftRestarts(), 0);                                                                                                                                                                             \
    }                                                                                                                                                                                                                      \
                                                                                                                                                                                                                           \
