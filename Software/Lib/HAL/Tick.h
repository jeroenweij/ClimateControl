...
namespace Hal
{
    namespace Tick
    {
        ...
        // overhead stretches every period by it (found bit-banging BitBangSerial
        // at 9600: ~8.85 us of Gpio::Write()/loop overhead per bit pushed the
        // real bit period to ~112.85 us and garbled every byte).
        uint32_t Micros();
